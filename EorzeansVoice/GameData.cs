...
namespace EorzeansVoice {
	public static class GameData {
		private class Offsets {
			...
			public const ulong combatantPtr = 0x1EA5B38; // ulong
			public const ulong nameWhenOnline = 0x1EA9239; // string(21)
			public const ulong mapID = 0x1E7B834; // int
			public const ulong instanceID = 0x1E770CC; // int
		}
